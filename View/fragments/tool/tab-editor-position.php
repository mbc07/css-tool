...
<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type="text" id="margin">
    <label class="mdl-textfield__label" for="left">Borda Esquerda</label>
</div>

<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type="text" id="border">
    <label class="mdl-textfield__label" for="right">Borda Direita</label>
</div>

<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type="text" id="padding">
    <label class="mdl-textfield__label" for="top">Borda Superior</label>
</div>

<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type="text" id="padding">
    <label class="mdl-textfield__label" for="bottom">Borda Inferior</label>
</div>
