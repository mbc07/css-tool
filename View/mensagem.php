        ...
        <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-tabs">
            <header class="mdl-layout__header app-navbar">
                ...
                <nav class="mdl-layout__tab-bar mdl-js-ripple-effect app-navbar">
                    <a href="?url=index" class="mdl-layout__tab is-active">Início</a>
                    <a href="?url=index" class="mdl-layout__tab">Ferramenta</a>
                    <a href="?url=index" class="mdl-layout__tab">Sobre</a>
                </nav>
                ...
                <div id="app-acoount-menu">
                    ...
                    <div class="mdl-card mdl-shadow--4dp app-account-card">
                        ...
                        if (!isset($_SESSION["id_usuario"]) || !isset($_SESSION["nome_usuario"])) {
                            //Usuário não logado
                            include "fragments/account/card-login.php";
                        } else {
                            //Usuário logado
                            include "fragments/account/card-account.php";
                        }
                        ?> 
